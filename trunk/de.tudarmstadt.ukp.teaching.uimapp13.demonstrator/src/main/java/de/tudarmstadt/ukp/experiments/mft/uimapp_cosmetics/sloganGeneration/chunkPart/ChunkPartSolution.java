...
/*
 * ChunkPartSolution is a solution generated by a ChunkPart instance during the slogan generation
 *
 * It has a model, which is the ChunkPart it is going to take the place in the generated slogan
 * (which is different from the ChunkPart it was generated from).
 * It has the constraints it complies with (word suggestion and body parts).
 * The lemma solution is the lemma that will be derived when this ChunkPartSolution will be derived into text.
 */
