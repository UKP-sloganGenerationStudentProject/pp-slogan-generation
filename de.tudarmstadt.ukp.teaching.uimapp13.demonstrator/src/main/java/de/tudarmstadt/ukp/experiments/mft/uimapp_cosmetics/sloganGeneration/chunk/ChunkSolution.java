...
implements Serializable
{
    ...
    /**
     * Generate, if possible (otherwise returns null) a new ChunkSolution concatenating
     *  the ChunkPartSolution given as input to a copy of the current instance.
     *
     * @param resources
    ...
    /**
     * Try to concatenate the ChunkPartSolution item given as input to the current instance.
